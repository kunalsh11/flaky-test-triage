...
* **Service Layer (`testService.js`)**: Encapsulates business logic: flakiness score calculation, logical execution aggregation, UTC date range handling, and database interactions.
